...
export const PRIMARY_BTN =
  'h-11 w-full rounded-lg border-0 bg-[oklch(0.50_0.13_58)] text-[0.875rem] font-semibold text-white shadow-[0_4px_16px_-4px_oklch(0.52_0.22_240/0.45)] transition-all hover:bg-[oklch(0.55_0.13_58)] active:scale-[0.99]'
